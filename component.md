...
| Newsletter | `src/components/Newsletter/Newsletter.jsx` | Email signup form for the newsletter. | `VITE_NEWSLETTER_WORKER_URL` env var | Rendered DOM + `fetch` POST to worker | Calls external worker on submit |
